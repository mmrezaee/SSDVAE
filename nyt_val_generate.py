...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_mode',type=str,help='Noah val or test? inverse narrative cloze?')
...
# ---------------  Nyt Inverse Narrative Cloze ---------------------
    ...
    args.valid_narr = './nyt_inv/inverse_cloze_{}_2k.txt'.format(args.data_mode)
