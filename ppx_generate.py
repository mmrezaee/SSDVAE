...
if __name__ == "__main__":
    ...
    args.valid_data = './data/{}_0.6_TUP.txt'.format(str(args.data_mode))
    ...
    args.valid_frames='./data/{}_0.6_frame.txt'.format(str(args.data_mode))
...
#                                  chain__emb_size_300_nlayers_2_lr_0.001_batch_size_150_seed_73_bidir_True_num_latent_values_500_latent_dim_500_use_pretrained_True_dropout_0.0_num_clauses_5_frame_max_500_obsv_prob_0.9_template_20_exp_num_1_model_chain_vocab_40064.pkl
